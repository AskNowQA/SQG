...
def main():
    ...
    if not os.path.isfile(dataset_vocab_file):
        token_files_a = [os.path.join(split, 'a.txt') for split in [train_dir, dev_dir, test_dir]]
        token_files_b = [os.path.join(split, 'b.txt') for split in [train_dir, dev_dir, test_dir]]
